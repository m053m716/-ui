classdef cubehelix_selector < matlab.mixin.SetGetExactNames
   ...
   methods (Access=public)
      function obj = cubehelix_selector(varargin)
         ...
         %  obj = ui.cubehelix_selector();
         %  obj =
         %     ui.cubehelix_selector(start,rots,sat,gamma,irange,domain);
         %  obj = ui.cubehelix_selector([start,rots,sat,gamma],...);
         ...
         obj.cm = ui.cubehelix_selector.new_cm_param(args{:});
      ...
      function export(obj)
         ...
         %  -> Copies input arguments to ui.cubehelix() that recreate
   ...
   methods (Static=true,Access=public)
      function cm = new_cm_param(N,start,rots,sat,gamma,irange,domain)
         ...
         %
         %  cm = ui.cubehelix_selector.new_cm_param(N,start,rots,sat,gamma,irange,domain);
         
         cm = ui.cubehelix(N,[start,rots,sat,gamma],irange,domain);
      end
   end
end